...
function joints_scripts_and_styles() {
    ...
    if (!is_admin()) {
  	...
  	wp_deregister_script('jquery');
  	 ...
  	 //jQuery
    wp_register_script('jquery', 'https://code.jquery.com/jquery-1.11.1.min.js',array(),'',true);
    
    //jQuery UI 
    wp_register_script('jquery-ui', 'https://code.jquery.com/ui/1.11.2/jquery-ui.min.js',array('jquery'),'',true);
    ...
    //App.js (our custom js file)
    //requires jquery and foundation to be loaded first
    wp_register_script('app-js', get_template_directory_uri().'/library/js/app.js', array('jquery','foundation-js'),'', true);
    
    // register main stylesheet
    wp_enqueue_style( 'joints-stylesheet', get_template_directory_uri() . '/library/css/style.css', array(),false,false);
    ...
    //on contact page, need to enqueue the map plugin thingy
    if (is_page(78)){
      wp_register_script('google-map','http://maps.googleapis.com/maps/api/js?key=AIzaSyCzaHSg_cUeVkiumeGf9c2nAAlun3Idn5o&sensor=false',array('jquery'),false,false);
