...
<section id="respond" class="respond-form">
	...
	<h3 id="comment-form-title" class="h2"><?php comment_form_title( __('Leave a Comment', 'jointstheme'), __('Leave a Reply to %s', 'jointstheme' )); ?></h3>
	...
	<ul id="comment-form-elements" class="clearfix">
		...
		<li>
		  <label for="author"><?php _e("Name", "jointstheme"); ?> <?php if ($req) echo "*"; ?></label>
		  <input type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" placeholder="" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
		</li>

		
		<li>
		  <label for="email"><?php _e("Email", "jointstheme"); ?> <?php if ($req) echo "*"; ?></label>
		  <input type="email" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" placeholder="" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
		</li>
		
		<li>
		  <label for="url"><?php _e("Website", "jointstheme"); ?></label>
		  <input type="url" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" placeholder="" tabindex="3" />
		</li>
  ...
  <label for="comment"><?php _e("Comment*", "jointstheme"); ?></label>
	<p><textarea name="comment" id="comment" placeholder="" tabindex="10"></textarea></p>
	
	<p>
	  <button name="submit" type="submit" id="submit" class="cta-button" tabindex="5">Submit A Comment<span class="arrows"></span></button>
